 ...
 *
 * @package     WTS_Showmore
 * @copyright   Copyright (c) 2013 Catalin Ciobanu
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License (OSL 3.0)
 */
class WTS_Showmore_Block_Catalog_Layer_Filter_Attribute extends Mage_Catalog_Block_Layer_Filter_Attribute
{
    ...
    public function __construct()
    {
        ...
        if ($this->helper('catalin_seo')->isEnabled()
             ...
             */
            $this->setTemplate('wts_showmore/catalog/layer/filter.phtml');
        }
    }
