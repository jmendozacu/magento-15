...
class Im_Giftregistry_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    {
        $model = Mage::getModel('im_giftregistry/entity');
    ...
    public function deleteAction()
    {
        try {
            ...
            if($registryId){
                if($registry = Mage::getModel('im_giftregistry/entity')->load($registryId))
                {
                    $registry->delete();
                    $successMessage =  Mage::helper('im_giftregistry')->__('Gift registry has been successfully deleted.');
