 ...
 */
class WTS_Mage_Catalog_Model_Resource_Layer_Filter_Price extends Mage_Catalog_Model_Resource_Layer_Filter_Price
{
    /**
    ...
    {
        //$minPrice = Mage::app()->getRequest()->getParam('min_price');
        //$maxPrice = Mage::app()->getRequest()->getParam('max_price');
